...
# 	data = response.json()
# 	latest_data_point_title = data['observations'][-1]['title']
# 	latest_data_point_value = data['observations'][-1]['value']
# 	latest_data_point_date = data['observations'][-1]['date']
# 	return latest_data_point_title, latest_data_point_value, latest_data_point_date
